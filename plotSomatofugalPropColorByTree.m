...
function h = plotSomatofugalPropColorByTree (mnProperties, parameters, metric, propName, sym, siz, cmap, showOnlyTree)
    ...
    if showOnlyTree
        ...
        h = plot(x, somatofugalProp, 'lineStyle', 'none', 'Marker', sym, 'MarkerSize', siz, 'Color', cmap(showOnlyTree,:));
        ...
        h = plot2DScatter( x, somatofugalProp, group_array, sym, siz, cmap);
    end
